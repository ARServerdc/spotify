    ...
    $(document).ready(function(){
        ...
        function mousecursor() {
            if ($("body")) {
                ...
                }, $("body").on("mouseenter", "button, .team-member-img, .arrow_right, .arrow_left, .clients-logo, .service-img, a, .cursor-pointer", function () {
                    e.classList.add("cursor-pointer-hover"), t.classList.add("cursor-pointer-hover")
                }), $("body").on("mouseleave", "button, .team-member-img, .arrow_right, .arrow_left, .clients-logo, .service-img, a, .cursor-pointer", function () {
                    $(this).is("button, .team-member-img, .arrow_right, .arrow_left, .clients-logo, .service-img, a") && $(this).closest(".cursor-pointer").length || (e.classList.remove("cursor-pointer-hover"), t.classList.remove("cursor-pointer-hover"))
